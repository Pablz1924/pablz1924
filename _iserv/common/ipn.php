...
function SendOrderEmail( $orderid, $emailtitle, $emailmessage ) {
	$MERCHANT_FROM = "<worldcompsell1@gmail.com>";
	$MERCHANT_BCC = true;
	$CRLF = "\r\n";
...
function DeliverOrderByEmail( $orderid ) 
{
	...
	$IPN_DEFAULT_LANG = "es";
	$IPN_SUPPORTED_LANGS = array( "es","en","fr","pt" ); 
	$IPN_EMAIL_FDL_TITLE = array( "es" => "Delivery of your order {OrderID}","en" => "Delivery of your order {OrderID}","fr" => "Livraison de votre commande {OrderID}","pt" => "Delivery of your order {OrderID}" );
	$IPN_EMAIL_FDL_MSG = array( "es" => "Dear {ClientName},\r\nplease find below the files you purchased in your order [OrderID}:\r\n\r\n{DLFILES}\r\nThanks you.","en" => "Dear {ClientName},\r\nplease find below the files you purchased in your order [OrderID}:\r\n\r\n{DLFILES}\r\nThanks you.","fr" => "Bonjour {ClientName},\r\nveuillez trouver ci-dessous les fichiers que vous avez achetés dans votre commande {OrderID}:\r\n\r\n{DLFILES}\r\nMerci et à bientôt.","pt" => "Dear {ClientName},\r\nplease find below the files you purchased in your order [OrderID}:\r\n\r\n{DLFILES}\r\nThanks you." );
